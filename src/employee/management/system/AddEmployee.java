...
public class AddEmployee extends JFrame implements ActionListener{
    ...
    JTextField tfname, tfage, tfaddress, tfphone, tfaadhar, tfemail, tfsalary, tfdesignation;
    JDateChooser dcdob;
    ...
    AddEmployee() {
        ...
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("Icons/AddEmployee.png"));
    ...
    public void actionPerformed(ActionEvent ae) {
        if (ae.getSource() == add) {
            ...
            try {
                ...
                String query = "insert into ems.employee values('"+name+"', '"+age+"', '"+dob+"', '"+salary+"', '"+address+"', '"+phone+"', '"+email+"', '"+education+"', '"+designation+"', '"+aadhar+"', '"+empId+"')";
